...
class Logger(object):
    def __init__(self, filename="gp_sofia_miner.log"):
...
class WQOnlineGP:
    ...
    def run_online_evolution(self, regional_seeds, num_generations=500):
        ...
        passed_path = "passed_alphas_sofia.csv"
        ...
        history_path = "gp_live_search_results_sofia.csv"
    ...
    def save_results_to_disk(self):
        ...
        history_df.to_csv("gp_live_search_results_sofia.csv", index=False)
        ...
        passed_df.to_csv("passed_alphas_sofia.csv", index=False)
        
        # Copy to Downloads
        import shutil
        try:
            shutil.copy2("gp_live_search_results_sofia.csv", r"C:\Users\HP\Downloads\gp_live_search_results_sofiajuma.csv")
            shutil.copy2("passed_alphas_sofia.csv", r"C:\Users\HP\Downloads\passed_alphas_sofiajuma.csv")
            shutil.copy2("gp_sofia_miner.log", r"C:\Users\HP\Downloads\gp_sofia_miner_sofiajuma.log")
        except Exception:
            pass
